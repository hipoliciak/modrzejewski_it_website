...
image: ./how-to-debug-salesforce-automation-event-triggered-flows/cover-automation-debug.png
...
![Flow variable configuration with “Available for input” enabled](./how-to-debug-salesforce-automation-event-triggered-flows/create-record-variable-available-for-input.avif)
...
![Flow debug configuration selecting a test record for the input variable](./how-to-debug-salesforce-automation-event-triggered-flows/debug-config-populating-input-variable.avif)
...
![Flow debug success](./how-to-debug-salesforce-automation-event-triggered-flows/debug-successful-run.avif)
